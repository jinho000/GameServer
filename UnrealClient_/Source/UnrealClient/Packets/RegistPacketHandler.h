...
{																		
	...
	m_handlerContainer.Add(PacketType::JoginResult, std::bind(&ProcessHandler<JoginResultPacketHandler, JoginResultPacket>, std::placeholders::_1, m_pGameInst, world));	
